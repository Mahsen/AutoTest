...
/* IPv4 fragmentation usage definitions */
...
/* mbedTLS interface configuration */
  ...
  static NET_DHCP_CFG eth0_dhcp_config = {
	...
	char LAN_IP4_Addr[16] __attribute__((section(ADDRESSRAM_LAN_IP4_ADDR)))/* = ETH0_IP4_ADDR*/;
	char LAN_IP4_Mask[16] __attribute__((section(ADDRESSRAM_LAN_IP4_MASK)))/* = ETH0_IP4_MASK*/;
	char LAN_IP4_Gateway[16] __attribute__((section(ADDRESSRAM_LAN_IP4_GATEWAY))) /* = ETH0_IP4_GATEWAY*/;
	char LAN_IP4_Primary_DNS[16] __attribute__((section(ADDRESSRAM_LAN_IP4_PRIMARY_DNS))) /* = ETH0_IP4_PRIMARY_DNS*/;
	char LAN_IP4_Secondary_DNS[16] __attribute__((section(ADDRESSRAM_LAN_IP4_SECONDARY_DNS))) /* = ETH0_IP4_SECONDARY_DNS*/;
	#ifdef __cplusplus
	}
	#endif
	/* ETH0: IPv4 configuration */
  ...
  static NET_IP4_CFG eth0_ip4_config = {
    (const char*)LAN_IP4_Addr,
    (const char*)LAN_IP4_Mask,
    (const char*)LAN_IP4_Gateway,
    (const char*)LAN_IP4_Primary_DNS,
    (const char*)LAN_IP4_Secondary_DNS,
