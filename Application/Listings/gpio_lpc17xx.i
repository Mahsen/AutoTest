#line 1 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\Keil\\LPC1700_DFP\\2.6.0\\RTE_Driver\\GPIO_LPC17xx.c"
...
#line 27 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\Keil\\LPC1700_DFP\\2.6.0\\RTE_Driver\\GPIO_LPC17xx.c"

#line 30 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\Keil\\LPC1700_DFP\\2.6.0\\RTE_Driver\\GPIO_LPC17xx.c"
...
#line 43 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\Keil\\LPC1700_DFP\\2.6.0\\RTE_Driver\\GPIO_LPC17xx.c"
...
void GPIO_PortClock (uint32_t clock) {
  ...
  if (clock) {
    ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP |=  (1U << 15);
  }
  else {
    ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP &= ~(1U << 15);
  }
...
void GPIO_SetDir (uint32_t port_num, uint32_t pin_num, uint32_t dir) {
  ...
  dir  ? (((LPC_GPIO_TypeDef *)(((0x2009C000UL) + 0x00000) + 0x00020*port_num))->FIODIR |=  (1UL << pin_num)) :          (((LPC_GPIO_TypeDef *)(((0x2009C000UL) + 0x00000) + 0x00020*port_num))->FIODIR &= ~(1UL << pin_num));
...
void GPIO_PinWrite (uint32_t port_num, uint32_t pin_num, uint32_t val) {
  ...
  val ? (((LPC_GPIO_TypeDef *)(((0x2009C000UL) + 0x00000) + 0x00020*port_num))->FIOSET = (1UL << pin_num)) :         (((LPC_GPIO_TypeDef *)(((0x2009C000UL) + 0x00000) + 0x00020*port_num))->FIOCLR = (1UL << pin_num));
...
uint32_t GPIO_PinRead (uint32_t port_num, uint32_t pin_num) {
  return ((((LPC_GPIO_TypeDef *)(((0x2009C000UL) + 0x00000) + 0x00020*port_num))->FIOPIN & (1UL << pin_num)) ? (1U) : (0U));
}
...
void GPIO_PortWrite (uint32_t port_num, uint32_t mask, uint32_t val) {
  ((LPC_GPIO_TypeDef *)(((0x2009C000UL) + 0x00000) + 0x00020*port_num))->FIOMASK = ~mask;
  ((LPC_GPIO_TypeDef *)(((0x2009C000UL) + 0x00000) + 0x00020*port_num))->FIOPIN  =  val;
}
...
uint32_t GPIO_PortRead (uint32_t port_num) {
  return (((LPC_GPIO_TypeDef *)(((0x2009C000UL) + 0x00000) + 0x00020*port_num))->FIOPIN);
}
