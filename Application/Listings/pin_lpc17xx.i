...
#line 27 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\Keil\\LPC1700_DFP\\2.6.0\\RTE_Driver\\PIN_LPC17xx.c"
...
#line 28 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\Keil\\LPC1700_DFP\\2.6.0\\RTE_Driver\\PIN_LPC17xx.c"
...
int32_t PIN_Configure (uint8_t port, uint8_t pin, uint8_t function, uint8_t mode, uint8_t open_drain) {
  ...
  (*((volatile uint32_t *) (&(((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL0) + 2U*port + regidx))) &= ~(0x03UL << (pinnum * 2U));
  (*((volatile uint32_t *) (&(((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL0) + 2U*port + regidx))) |= ((uint32_t)function) << (pinnum * 2U);

  
  (*((volatile uint32_t *) (&(((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINMODE0) + 2U*port + regidx))) &= ~(0x03UL << (pinnum * 2U));
  (*((volatile uint32_t *) (&(((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINMODE0) + 2U*port + regidx))) |= ((uint32_t)mode) << (pinnum * 2U);
  
  
  if (open_drain == ((uint32_t)(1))) {
    (*((volatile uint32_t *) (&(((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINMODE_OD0) + port))) |=  (0x01UL << pin);
  }
  else {
    (*((volatile uint32_t *) (&(((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINMODE_OD0) + port))) &= ~(0x01UL << pin);
  }
...
int32_t PIN_ConfigureTPIU (_Bool enable)
{
  if (enable == 1) {
...
int32_t PIN_ConfigureI2C0Pins (uint8_t i2cPinMode, _Bool enableFilterSlewRate)
{
  uint32_t regVal = 0U;

  if (i2cPinMode == ((uint32_t)(2))){
    regVal |= ((uint32_t)(1 << 2)) | ((uint32_t)(1 << 0));
  }

  if (enableFilterSlewRate == 0){
    regVal |= ((uint32_t)(1 << 3)) | ((uint32_t)(1 << 1));
  }
