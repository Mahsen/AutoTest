...
#line 1 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\ARM\\CMSIS\\5.7.0\\CMSIS\\RTOS\\RTX\\INC\\RTX_CM_lib.h"
...
#pragma O3
#line 38 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\ARM\\CMSIS\\5.7.0\\CMSIS\\RTOS\\RTX\\INC\\RTX_CM_lib.h"
...
#line 104 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\ARM\\CMSIS\\5.7.0\\CMSIS\\RTOS\\RTX\\INC\\RTX_CM_lib.h"
...
#line 129 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\ARM\\CMSIS\\5.7.0\\CMSIS\\RTOS\\RTX\\INC\\RTX_CM_lib.h"
...
uint32_t const os_stackinfo  = (0<<28) | (1<<24) | ((5 + 2)<<16) | (50*4);
uint32_t const os_rrobin     = (0 << 16) | 5;
uint32_t const os_tickfreq   = 100000000;
uint16_t const os_tickus_i   = 100000000/1000000;
uint16_t const os_tickus_f   = (((uint64_t)(100000000-1000000*(100000000/1000000)))<<16)/1000000;
uint32_t const os_trv        = ((uint32_t)(((double)100000000*(double)1000)/1E6)-1);
...
extern
uint64_t       mp_stk[];
uint64_t mp_stk[(((50*4)+7)/8)*((6 + 1)-(5 + 2)+1) + 2];
extern
...
uint64_t       os_stack_mem[2+(5 + 2)+((4*(1024+256+50))/8)];
extern
...
extern
uint32_t       os_fifo[];
uint32_t       os_fifo[8*2+1];
extern
uint8_t  const os_fifo_size;
uint8_t  const os_fifo_size = 8;
...
osMessageQId osMessageQId_osTimerMessageQ;
#line 228 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\ARM\\CMSIS\\5.7.0\\CMSIS\\RTOS\\RTX\\INC\\RTX_CM_lib.h"
...
#line 395 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\ARM\\CMSIS\\5.7.0\\CMSIS\\RTOS\\RTX\\INC\\RTX_CM_lib.h"
...
const osThreadDef_t os_thread_def_main = {(os_pthread)main, osPriorityNormal, 1U, 4*256 };
...
#line 555 "C:\\Users\\Mohammad\\AppData\\Local\\Arm\\Packs\\ARM\\CMSIS\\5.7.0\\CMSIS\\RTOS\\RTX\\INC\\RTX_CM_lib.h"
