...
U8 HEXTYPE_Ascii2Hex(U8* Convert)
{
	return (((HEXTYPE_Ascii2Hex(Convert[0]) << 4) & 0xF0) | (HEXTYPE_Ascii2Hex(Convert[1]) & 0x0F));
}
//_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
/**
 * @brief 	Convert Ascii to Hex
...
//_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
void HEXTYPE_ShiftLeftArray(U8* Data, U16 Data_Length, U16 Shift)
{

	for(S16 Index = 0; Index<Data_Length; Index++)
	{
		if((Index - Shift) >= 0)
		{
...
//		else
//		{
//			Data[Data_Length - (Shift - Index)] = Data[Index];
//		}
	}
}
//_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
void HEXTYPE_ShiftRightArray(U8* Data, U16 Data_Length, U16 Shift)
{

	Data_Length = Data_Length - 1;
	for(S16 Index = Data_Length; Index>=0; Index--)
	{
		if((Index + Shift) <= Data_Length)
		{
			Data[Index + Shift] = Data[Index];
		}
//		else
