...
void TEST_1_Blink(U8* Data) {
  ...
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
	...
	for(U8 Index=0; Index<100; Index++) {
...
void Application(void *argument)
{
	/* Add tests */
	/* TEST 1 */	
	Application_Test[0].Add((uint8_t*)"Location", &TEST_1_Location, true);
	Application_Test[0].Add((uint8_t*)"Blink", &TEST_1_Blink, false);
	Application_Test[0].Add((uint8_t*)"HardwareVersion", &TEST_HardwareVersion, true);
	Application_Test[0].Add((uint8_t*)"SoftwareVersion", &TEST_SoftwareVersion, true);
	/* TEST 2 */
	Application_Test[1].Add((uint8_t*)"Location", &TEST_2_Location, true);
	Application_Test[1].Add((uint8_t*)"Blink", &TEST_2_Blink, false);
	Application_Test[1].Add((uint8_t*)"HardwareVersion", &TEST_HardwareVersion, true);
	Application_Test[1].Add((uint8_t*)"SoftwareVersion", &TEST_SoftwareVersion, true);
	/* TEST 3 */
	Application_Test[2].Add((uint8_t*)"Location", &TEST_3_Location, true);
	Application_Test[2].Add((uint8_t*)"Blink", &TEST_3_Blink, false);
	Application_Test[2].Add((uint8_t*)"HardwareVersion", &TEST_HardwareVersion, true);
	Application_Test[2].Add((uint8_t*)"SoftwareVersion", &TEST_SoftwareVersion, true);
	/* TEST 4 */
	Application_Test[3].Add((uint8_t*)"Location", &TEST_4_Location, true);
	Application_Test[3].Add((uint8_t*)"Blink", &TEST_4_Blink, false);
	Application_Test[3].Add((uint8_t*)"HardwareVersion", &TEST_HardwareVersion, true);
	Application_Test[3].Add((uint8_t*)"SoftwareVersion", &TEST_SoftwareVersion, true);
...
//	}
	Lan.Init();
	for(int Index=0; Index<LAN_SIZEOF_LISTEN; Index++) {
		/* Add Lan listening */
