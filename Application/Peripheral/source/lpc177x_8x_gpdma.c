...
#else
volatile const char* GPDMA_LUTPerAddr[] = {
		0, 											// Reversed
		((char*)&LPC_MCI->FIFO),					// SD Card
		((char*)&LPC_SSP0->DR),					// SSP0 Tx
		((char*)&LPC_SSP0->DR),					// SSP0 Rx
		((char*)&LPC_SSP1->DR),					// SSP1 Tx
		((char*)&LPC_SSP1->DR),					// SSP1 Rx
		((char*)&LPC_SSP2->DR),					// SSP2 Tx
		((char*)&LPC_SSP2->DR),					// SSP2 Rx
		((char*)&LPC_ADC->GDR),					// ADC
		((char*)&LPC_DAC->CR),					// DAC
		((char*)&LPC_UART0->/*RBTHDLR.*/THR),	// UART0 Tx
		((char*)&LPC_UART0->/*RBTHDLR.*/RBR),	// UART0 Rx
		((char*)&LPC_UART1->/*RBTHDLR.*/THR),	// UART1 Tx
		((char*)&LPC_UART1->/*RBTHDLR.*/RBR),	// UART1 Rx
		((char*)&LPC_UART2->/*RBTHDLR.*/THR),	// UART2 Tx
		((char*)&LPC_UART2->/*RBTHDLR.*/RBR),	// UART2 Rx
		((char*)&LPC_TIM0->MR0),					// MAT0.0
		((char*)&LPC_TIM0->MR1),					// MAT0.1
		((char*)&LPC_TIM1->MR0),					// MAT1.0
		((char*)&LPC_TIM1->MR1),					// MAT1.1
		((char*)&LPC_TIM2->MR0),					// MAT2.0
		((char*)&LPC_TIM2->MR1),					// MAT2.1
		((char*)&LPC_I2S->TXFIFO), 				// I2S Tx
		((char*)&LPC_I2S->RXFIFO), 				// I2S Rx
		0,											// Reverse
		0,											// Reverse
		((char*)&LPC_UART3->/*RBTHDLR.*/THR),	// UART3 Tx
		((char*)&LPC_UART3->/*RBTHDLR.*/RBR),	// UART3 Rx
		((char*)&LPC_UART4->/*RBTHDLR.*/THR),	// UART4 Tx
		((char*)&LPC_UART4->/*RBTHDLR.*/RBR),	// UART4 Rx
		((char*)&LPC_TIM3->MR0),					// MAT3.0
		((char*)&LPC_TIM3->MR1),					// MAT3.1
};
#endif
/**
